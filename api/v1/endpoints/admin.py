...
from api.v1.endpoints import admin_subscription_push, admin_prediction_reports, admin_stock_index, admin_polymarket
...
router.include_router(admin_polymarket.router)
