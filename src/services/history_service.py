    ...
    def _rebuild_analysis_result(
        ...
        try:
            ...
            return AnalysisResult(
                ...
                financial_fundamentals_analysis=raw_result.get("financial_fundamentals_analysis"),
                technical_analysis_report=raw_result.get("technical_analysis_report"),
                price_trend_analysis=raw_result.get("price_trend_analysis"),
                key_levels_analysis=raw_result.get("key_levels_analysis"),
                weekly_trend_analysis=raw_result.get("weekly_trend_analysis"),
                capital_flow_analysis=raw_result.get("capital_flow_analysis"),
