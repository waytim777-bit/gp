...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MULTI_MODEL_PANEL_ENABLED": {
        "title": "多模型会诊",
        "description": "主 Agent 分析完成后，将同一 analysis brief 推送给其他模型做只读会诊（不调工具）。",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "MULTI_MODEL_PANEL_MODELS": {
        "title": "会诊模型列表",
        "description": "逗号分隔的会诊模型（不含主 Agent 模型）。留空时自动使用渠道内除主模型外的全部模型。",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "DEPOSIT_RECEIVER_ADDRESS": {
        "title": "充值接收地址（旧版）",
        "description": "旧版 ERC20 直接转账充值的接收地址；合约充值流程不再使用。",
        "category": "payment",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "DEPOSIT_CONTRACT_ADDRESS": {
        "title": "充值合约地址",
        "description": "用于调用 deposit(amount) 的 Sepolia 充值合约地址。",
        "category": "payment",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
