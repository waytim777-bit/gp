            ...
            <table className="min-w-[500px] w-full table-fixed text-left">
              <thead>
                <tr className="text-xs font-medium leading-none text-secondary-text">
                  <th className="w-[20%] pb-3.5 pr-4">{copy.period}</th>
                  <th className="w-[24%] pb-3.5 pr-4">{copy.revenue}</th>
                  <th className="w-[34%] pb-3.5 pr-4">{copy.profitAndRd}</th>
                  <th className="w-[22%] pb-3.5 text-right">{copy.revenueYoy}</th>
                </tr>
              </thead>
              <tbody className="text-sm font-semibold leading-none text-foreground">
                {rows.slice(0, 8).map((row, index) => (
                  <tr key={`${row.period}-${index}`}>
                    ...
                    <td
                      className={`py-2.5 text-right font-mono ${getFullReportGrowthClassName(row.revenueYoy)}`}
                    >
                      {formatGrowthPct(row.revenueYoy)}
                    </td>
                  </tr>
